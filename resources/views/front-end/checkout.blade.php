      ...
      <div class="col l4">
        <div class="panel-body">
          <div class="order">
            ...
            <span class="title"> ({{Cart::getTotalQuantity()}} sản phẩm)</span>
          ...
          <div class="product">
             @foreach (Cart::getContent() as $row)
              <div class="item">
                <p class="title">
                    <strong>{{$row->quantity}} x</strong><a href="" target="_blank">{{$row->name}}</a>
                </p>
                <p class="price">
          ...
          <p class="total2">
              <b>Thành tiền:</b>
              <span>{{Cart::getTotal()+$shipfee}}</span>&nbsp;₫
          </p>
        </div>
      </div>
    </div>
